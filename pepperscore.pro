...
CONFIG += thread
CONFIG += static 
QMAKE_CXXFLAGS += -fpermissive -std=gnu++11 -Wno-deprecated-declarations
...
contains(PEPPERSCORE_NEED_QT_PLUGINS, 1) {
    DEFINES += PEPPERSCORE_NEED_QT_PLUGINS
...
HEADERS += src/qt/pepperscoregui.h \
    ...
    src/qt/pepperscoreaddressvalidator.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    src/chainparams.h \
    ...
    src/qt/pepperscoreamountfield.h \
    src/wallet.h \
    src/keystore.h \
...
SOURCES += src/qt/pepperscore.cpp src/qt/pepperscoregui.cpp \
    ...
    src/qt/pepperscoreaddressvalidator.cpp \
    src/chainparams.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/txmempool.cpp \
    ...
    src/qt/pepperscorestrings.cpp \
    src/qt/pepperscoreamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/pepperscore.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/pepperscore_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/pepperscore-qt.rc
...
windows:RC_FILE = src/qt/res/pepperscore-qt.rc
...
INCLUDEPATH += $$BOOST_INCLUDE_PATH $$BDB_INCLUDE_PATH $$OPENSSL_INCLUDE_PATH $$MINIUPNPC_INCLUDE_PATH $$QRENCODE_INCLUDE_PATH

LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(MINIUPNPC_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,)
