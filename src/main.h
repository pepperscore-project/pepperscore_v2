...
#ifndef PEPPERSCORE_MAIN_H
#define PEPPERSCORE_MAIN_H
...
static const int64_t MIN_TX_FEE = 0.0000001 * COIN;
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 3180000 * COIN; // 3.18 million
...
inline bool BonusPOS(int nHeight) { return TestNet() || nHeight > 100; }
...
public:
    ...
    /** Amount of pepperscores spent by this transaction.
    ...
    /** Amount of pepperscores coming in to this transaction
