...
bool IsDERSignature(const valtype &vchSig, bool haveHashType) {
    // See https://bicointalk.org/index.php?topic=8392.msg127623#msg127623
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Pepperscore address tx, sender provides hash of pubkey, receiver provides signature and pubkey
