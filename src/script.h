...
#ifndef H_PEPPERSCORE_SCRIPT
#define H_PEPPERSCORE_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPepperscoreAddress
 */
...
public:
    ...
    // Pre-version-0.6, Pepperscore always counted CHECKMULTISIGs
